...
script_hex="${op_push_data_2bytes_hex}${lehex}${op_checksequenceverify}${op_drop}${op_dup}${op_hash160}${op_push_data_20bytes_hex}${publicKey_hash}${op_equalverify}${op_checksig}"
